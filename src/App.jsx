      ...
      <div className="product-section-container">
        ...
        <div className="product-card-list">
          <div className="product-card">
            ...
            {/*                Todo 5: ให้ Declare ตัว Component Button เพื่อ Render ปุ่ม “Add to Cart” ที่ซ้ำกันอยู่                (จุดที่ 1)              */}
            <AddtoCardButton />
...
function App() {
  return (
    <div>
      {/*        Todo: 1 ให้ Declare ตัว Component ย่อย        เพื่อแบ่งสัดส่วนของ HTML Element ในส่วนของ <header>       */}
      <Header />
      {/*      Todo 2: ให้ Declare ตัว Component ย่อย        เพื่อแบ่งสัดส่วนของ HTML Element ในส่วนของ <main>       */}
      <Main />
      {/*        Todo 3: ให้ Declare ตัว Component ย่อย        เพื่อแบ่งสัดส่วนของ HTML Element ในส่วนของ <section className="product-section">       */}
      <Product />
      {/*
